      ...
      builder: (context) {
        ...
        return DefaultTabController(
          ...
          child: Scaffold(
                            ...
                            Padding(
                              ...
                              child: TabBar(
                                ...
                                tabs: List<Widget>.generate(
                                    _con.categorias.length, (index) {
                                  return Tab(
                                    child: Text(
                                        _con.categorias[index].nombre ?? ''),
                                  );
                                }),
                                onTap: (index) async {
                                  ...
                                  List<Producto> productosCategoria =
                                      await _con.getProductosPorCategoria(
                                          _con.categorias[index]);
                                  setState(() {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TabBar(
                          ...
                          tabs: List<Widget>.generate(_con.categorias.length,
                              (index) {
                            return Tab(
            ...
            floatingActionButton: crossAxisCount > 3
                ? Container()
                : Container(
            ...
            floatingActionButtonLocation: crossAxisCount > 3
                ? null
        ...
        setState(() {
          if(_con.mesa.estadoMesa != 2){
            if (_con.productosSeleccionados?.any((p) => p.nombreproducto == producto.nombreproducto) ?? false) {
              final Producto? productoExistente = _con.productosSeleccionados?.firstWhere((p) => p.nombreproducto == producto.nombreproducto && p.precioproducto == producto.precioproducto);
              if (productoExistente != null) {
                print('------- ${_con.productosSeleccionados?.first.stock}');
                setState(() {
