...
//   var bdProducto = ProductoServicio();
...
//                         if(widget.mesa!.estadoMesa != 2) _iconDelete(index),
//                         const SizedBox(width: 5),
//                         if(widget.mesa!.estadoMesa != 2) _iconNota(index),
//                       ],
//                     ),
//                   ),
...
//                           gif();
//                           if(await moduloService.consultarRestriccion(context)){
//                             List<Producto> productosbd = await bdProducto.consultarStockProductos(mozo?.id_establecimiento, widget.productosSeleccionados!);
//
//                             List<Producto> productosSinStock = [];
//                             List<Producto> productosInhabilitado = [];
//
//                             for (final producto in productosbd){
//                               print(producto.toJson());
//                               if(producto.estado == 0){
//                                 print('add');
//                                 productosInhabilitado.add(producto);
//                               }
//                               if(producto.stock! <= 1){
//                                 print('add');
...
//                               }
//                               else {
//                                 // Busca el producto seleccionado correspondiente, si existe
//                                 Producto? productoSeleccionado = widget.productosSeleccionados!.firstWhere(
//                                         (element) => element.codigo_interno == producto.codigo_interno
//                                 );
//
//                                 // Verifica si el producto seleccionado existe y resta el stock
//                                 if ((producto.stock! - productoSeleccionado.stock!) <= 1) {
//                                   print('add');
//                                   productosSinStock.add(producto);
//                                 }
//                               }
...
//                               mostrarMensajeActualizado('Algunos productos no tienen stock', true);
//                               Navigator.pop(context);
//                             }
//                             // else if (productosSinStock.isEmpty){
//                             //   print('0 productos sin stock');
//                             // }
//
//                             if (productosInhabilitado.isNotEmpty) {
//                               mostrarMensajeActualizado('Algunos productos estan inhabilitados', true);
//                               print('El producto esta inhabilitado');
//                             }
//                             // else if (productosInhabilitado.isEmpty) {
//                             //   print('0 productos inhabilitados');
//                             //   Navigator.pop(context);
//                             // }
//
//                             if (productosInhabilitado.isEmpty && productosSinStock.isEmpty){
...
//                   bool success = await bdProducto.cambiarStockProducto(context, mozo?.id_establecimiento, producto);
//                   if (!success) {
//                     mostrarMensajeActualizado('Error al actualizar el stock para el producto: ${producto.nombreproducto}', true);
//                   }
//                 }
//
...
//                   selectObjmesa.nombrePiso = retornoMesa.nombrePiso;
//                   widget.mesa?.nombrePiso = retornoMesa.nombrePiso;
...
//                 // Actualizar mesa
//                 //print(retornoPedido);
//                 print('Puedes generar el pedido');
//               }
//
//               print('activo');
//             }
